...
import com.khalil.ssm.blog.mapper.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment getCommentById(Integer commentId) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("根据评论ID获得评论，commentId:{}, cause:{}", commentId, e);
        }
        return comment;
    }
    ...
    public List<Comment> listChildComment(Integer commentId) {
        ...
        try {
            childCommentList = commentMapper.listChildComment(commentId);
        } catch (Exception e) {
            e.printStackTrace();
